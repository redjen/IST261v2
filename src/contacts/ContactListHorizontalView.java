...
/**
 * ContactListHorizontalView is the view for displaying contacts and the controls for
 ...
 *
 */
public class ContactListHorizontalView extends JPanel {
   ...
   public ContactListHorizontalView() {
      super();
